...
using Efarming_Sustainability.App.Views.Productivity;
...
namespace Efarming_Sustainability.App.Models_View
{
    public class DashboardFarmsViewModel
    {
        ...
        public ICommand OpenProductivityCommand { get; }
        ...
        public DashboardFarmsViewModel(Farm farm, IAlert alert)
        {
            ...
            OpenProductivityCommand = new Command(async () => await OpenProductivity());
        }
        ...
        private async Task OpenProductivity()
        {
            if (SelectedFarm == null)
            {
                await Application.Current.MainPage.DisplayAlert("Error", "No hay finca seleccionada.", "OK");
            ...
            await Application.Current.MainPage.Navigation.PushAsync(new DashboardProductivity(SelectedFarm.Id, _alert));
